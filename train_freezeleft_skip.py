...
def train(args, model_left, model_right, optimizer):
    ...
    tr_resize = transforms.Resize((args.img_size, args.img_size))
        ...
        for i in pbar:
            ...
            if i % 100 == 0:
                with torch.no_grad():
                    ...
                    utils.save_image(
                        model_single_right.reverse(right_glow_out['z_outs'], reconstruct=True,
                                                   left_glow_out=left_glow_out,
                                                   image_lr_resize=image_lr_resize).cpu().data,
                    ...
                    utils.save_image(
                        model_single_right.reverse(z_sample_hr, reconstruct=False,
                                                   left_glow_out=left_glow_out,
                                                   image_lr_resize=image_lr_resize).cpu().data,
